      ...
      <div className="container mx-auto px-5 sm:px-8 lg:px-5">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-20">
          <div className="lg:col-span-5">
            <div className="relative  overflow-hidden rounded-lg bg-white/10 w-[538px] h-[597px]">
              <Image
                src="/about2.png"
          ...
          <div className="lg:col-span-7">
            <div className="max-full">
              ...
              <p className="mt-6 text-base leading-7 text-[#E6E6E6] sm:text-lg sm:leading-8">
              ...
              <ul className="mt-3 space-y-2 text-base text-[#E6E6E6] sm:text-lg">
              ...
              <p className="mt-3 text-base leading-7 text-[#E6E6E6] sm:text-lg sm:leading-8">
