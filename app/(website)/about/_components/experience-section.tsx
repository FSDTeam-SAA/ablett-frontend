  ...
  return (
    <section className="bg-black py-14 text-white sm:py-16 md:py-20 lg:py-[120px]">
      <div className="container mx-auto px-5 sm:px-8 lg:px-5">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center xl:gap-20">
          <div className="lg:col-span-5 xl:col-span-5">
            <div className="relative h-[360px] w-full overflow-hidden rounded-lg bg-white/10  xl:h-[480px] lg:h-[497px] lg:w-full xl:w-[538px]">
              <Image
                src="/about2.png"
          ...
          <div className="lg:col-span-7 xl:col-span-7">
            <div className="max-full">
              <h2 className="text-[34px] font-normal leading-tight sm:text-[42px] lg:text-[40px] xl:text-[44px]">
              ...
              <p className="mt-4 text-sm leading-7 text-[#E6E6E6] sm:mt-6 lg:text-base xl:text-lg sm:leading-8">
              ...
              <ul className="mt-3 space-y-2 text-sm text-[#E6E6E6] lg:text-base xl:text-lg">
              ...
              <p className="mt-3 text-sm leading-7 text-[#E6E6E6] lg:text-base xl:text-lg sm:leading-8">
