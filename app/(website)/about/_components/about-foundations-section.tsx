        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.35fr] lg:gap-20">
            ...
            <div className="grid gap-5 sm:grid-cols-3 lg:grid-cols-1">
              {stats.map((item) => (
                <CountUpStat
                  ...
                  suffix={item.suffix}
                  label={item.label}
                  valueClassName="text-[38px] font-medium leading-none sm:text-5xl"
                  labelClassName="mt-2 text-base leading-6 text-white/90 sm:text-xl"
                />
              ))}
            </div>
          </div>
          ...
          <div className="space-y-3 text-sm leading-7 text-[#E6E6E6] sm:text-lg sm:leading-8 lg:pt-1">
            <p>
              ...
              begins with understanding our clients&apos; vision, carefully planning
              each stage, and applying proven construction practices that ensure
              durability, safety, and long-term value.
            </p>

            <p>
              Over the years, we&apos;ve continued to grow by staying committed to
              the principles that matter most: honest communication, dependable
              service, skilled workmanship, and attention to every detail.
              Whether working on residential, commercial, or site development
              projects, our focus remains the same delivering reliable solutions
              that exceed expectations and leave a lasting impression.
            </p>
          </div>
        </div>
      </div>
